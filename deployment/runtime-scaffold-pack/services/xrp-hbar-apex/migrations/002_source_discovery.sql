...
CREATE INDEX IF NOT EXISTS source_verification_candidate_idx
    ON source_verification (candidate_id, verified_at DESC);
...
CREATE INDEX IF NOT EXISTS integration_decision_candidate_idx
    ON integration_decision (candidate_id, decided_at DESC);
